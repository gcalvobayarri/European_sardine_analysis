...
library(rjags)
library(mnormt)
source('./cpo_joint_log/mixed_joint/draws.R') #saved in draws_posterior
...
log_cpo_i <- function(datamI, datamA, draws, wI, wA, i, log = TRUE) { 
...
log_cpo_mixed_joint <- log_cpo
save(log_cpo_mixed_joint, 
     file = './cpo_joint_log/mixed_joint/log_cpo_mixed_joint.RData')
